...
export default function TopStoreRevenuesPage() {
  ...
  // Fetch top store revenues when store or dates change
  useEffect(() => {
    if (!storesLoading) {
      fetchData();
    }
      ...
      <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl p-5 shadow-xl shadow-gray-100/50 dark:shadow-none space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="flex flex-col gap-1.5 md:col-span-2">
            ...
            <DatePicker
              id="top-store-revenues-date-range"
              mode="range"
        ...
        <div className="space-y-8">
          <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl shadow-xl shadow-gray-100/30 dark:shadow-none p-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
              ...
              <button className="flex items-center gap-2 px-4 py-2 bg-slate-800 hover:bg-slate-700 text-white text-sm font-semibold rounded-lg transition-colors">

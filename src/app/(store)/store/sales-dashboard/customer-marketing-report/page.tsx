...
export default function StoreCustomerMarketingReportPage() {
  ...
  const handleExport = () => {
    ...
    exportSheetsToExcel('BC6_KhachHang_Marketing_CuaHang', [
      {
        name: 'Tổng quan',
        rows: buildScopeHeaderRows({
          reportName: 'BC#6 Báo cáo Khách hàng & Marketing (Cửa hàng)',
          fromDate,
          toDate,
        }),
      },
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6 text-gray-800 dark:text-gray-100">
      ...
      <StoreDateFilter
        ...
        datePickerId="store-customer-marketing-date-range"
      />

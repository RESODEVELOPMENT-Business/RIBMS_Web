...
export default function StoreTopStoreRevenuesPage() {
  const { storeId, fromDate, toDate, setDateRange } = useStoreDashboardFilters(0);
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6 text-gray-800 dark:text-gray-100">
      ...
      <StoreDateFilter
        ...
        datePickerId="store-top-revenues-date-range"
      />
